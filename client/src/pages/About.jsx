        ...
        <Container maxWidth={"1200px"} px={20} >
            <div className='pt-44 text-center' >
                <Box className='bg-black rounded-2xl py-4 px-4' style={{boxShadow:"6px 8px 15px rgba(0, 0, 0, 1)"}}>
                    ...
                    <p className='text-white py-4 px-4'>If you have any questions or need assistance, our dedicated customer support team is always here to help. Get ready to explore the world of auto parts like never before with AutoPartsWorld!</p>
                </Box>
            </div>
        </Container>
    )
