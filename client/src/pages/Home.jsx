...
export default function Home() {
  return (
    <div className="w-screen h-screen text-white pt-16" style={{
      ...
      <div className="container mx-auto flex px-5 pt-20 items-center justify-center flex-col">
        <img 
          ...
          className="lg:w-2/6 md:w-3/6 w-5/6 h-[400px] rounded-3xl mb-10 object-cover object-center" 
          alt="Car Image" 
        ...
        <div className="text-center lg:w-5/12 w-full">
          ...
          <div className="flex justify-center mx-auto">
            <Link to="/listings">
              <button
                style={{boxShadow:"4px 5px 15px rgba(0, 0, 0, 1)"}}
                className="hover:underline bg-black text-white font-bold rounded-full hover:bg-gray transition duration-300 py-4 px-8">
                View Listings
              </button>
            </Link>
            <Link to="/users">
              <button
                style={{boxShadow:"4px 5px 15px rgba(0, 0, 0, 1)"}}
                className="ml-4 hover:underline bg-black text-white font-bold rounded-full hover:bg-gray transition duration-300 py-4 px-8">
                View Users
              </button>
            </Link>
            <Link to="/profile">
